...
insert into cd.facilities(name) values('Tennis Court 1');
insert into cd.facilities(name) values('Tennis Court 2');
insert into cd.facilities(name) values('Badminton Court');
insert into cd.facilities(name) values('Table Tennis');
insert into cd.facilities(name) values('Massage Room 1');
insert into cd.facilities(name) values('Massage Room 2');
insert into cd.facilities(name) values('Squash Court');
insert into cd.facilities(name) values('Snooker Table');
insert into cd.facilities(name) values('Pool Table');
